...
public class NoChildren extends GPathResult {
  ...
  //     /* (non-Javadoc)
  //     * @see
  // org.codehaus.groovy.sandbox.util.slurpersupport.GPathResult#find(groovy.lang.Closure)
  //     */
  ...
  //     /* (non-Javadoc)
  //     * @see
  // org.codehaus.groovy.sandbox.util.slurpersupport.GPathResult#findAll(groovy.lang.Closure)
  //     */
