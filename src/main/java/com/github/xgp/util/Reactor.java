...
/**
 * Simple reactor that takes items from a queue and hands them
 * off to threads for processing. Restricts concurrency permits 
 * with a semaphore.
 */
public class Reactor<T> implements Runnable {
    ...
    public Reactor(BlockingQueue<T> queue,
