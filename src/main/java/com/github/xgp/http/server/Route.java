// modified from: https://github.com/ninjaframework/ninja/blob/develop/ninja-core/src/main/java/ninja/Route.java
...
public class Route {
     ...
     * @return A list containing the parameter name in the order they were
